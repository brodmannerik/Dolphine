...
# additional
MIN_CONFIDENCE_1 = 0.6
MIN_CONFIDENCE_2 = 0.8
            ...
            if classNames[classId-1] == "person" or classNames[classId-1] == "dog" or classNames[classId-1] == "hat" or classNames[classId-1] == "teddy bear" or classNames[classId-1] == "bear": 
                ...
                if(go):
                    ...
                    if(get == "ok\r\n"):
                        ...
                        if confidence < MIN_CONFIDENCE_1:
                            # Do something if confidence is less than 60%
                        ...
                        elif confidence < MIN_CONFIDENCE_2:
                            # Do something if confidence is less than 80%
                            print("Confidence is less than 80%")
                            ...
                            # Do something if confidence is greater than or equal to 80%
                            print("Confidence is greater than or equal to 80%")
